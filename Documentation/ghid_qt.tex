...
\begin{document}
    ...
    \begin{enumerate}
    	...
    	\item Deschideți proiectul \textit{TicTacToe}, selectați \textit{TicTacToeUI} ca proiect de startup și rulați. Erorile ce pot apărea (neidentificarea directorului \texttt{include} sau a fișierelor \texttt{.dll} din \texttt{bin}) sunt cauzate de căi configurate greșit; verificați secțiunea \textbf{'Qt Project Settings'}. Fiind un proiect extern e posibil să aibă setată versiunea de Qt greșită, modificați la \textit{Qt Project Properties} să folosească versiunea voastră de Qt la \textit{Qt Installation}
